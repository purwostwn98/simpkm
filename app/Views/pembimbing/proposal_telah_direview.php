    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Proposal Telah Direview</h4>
                    <nav aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item">
                                <a class="text-muted text-decoration-none" href="../main/index.html">Home</a>
                            </li>
                            <li class="breadcrumb-item" aria-current="page">Proposal Telah Direview</li>
                        </ol>
                    </nav>
                </div>
                <div class="col-3">
        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="table-responsive">
                    <table id="zero_config" class="table table-md table-striped table-bordered align-middle w-100">
                        <thead>
                            <!-- start row -->
                            <tr>
                                <th class="text-white" style="background-color: #2f3185;">No.</th>
                                ...
                                <th class="text-white" style="background-color: #2f3185;">Ketua</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>1</td>
                                <td><span class="mb-1 badge rounded-pill bg-success">Diterima</span></td>
                                <td>
                            ...
                            <tr>
                                ...
                                <td>Falah Nurul</td>
                                <td>2</td>
                                <td><span class="mb-1 badge rounded-pill bg-danger">Ditolak</span></td>
                                <td>
                                    <button style="border: 1px solid #fec14f;" class="btn bg-warning-subtle text-warning btn-sm dropdown-toggle" type="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        Atur
                                    </button>

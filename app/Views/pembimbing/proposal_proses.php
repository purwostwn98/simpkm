    ...
    <div class="card bg-info-subtle shadow-none position-relative overflow-hidden mb-4">
        <div class="card-body px-4 py-3">
            <div class="row align-items-center">
                <div class="col-9">
                    <h4 class="fw-semibold mb-8">Proposal dalam Proses Review</h4>
        ...
        <div class="card">
            <div class="card-body">
                ...
                <p class="card-subtitle mb-3">
                    Di halaman ini berisi daftar proposal yang sedang dalam proses review.
                </p>
                    ...
                    <table id="zero_config" class="table table-striped table-bordered text-nowrap align-middle">
                        <thead>
                            ...
                            <tr>
                                ...
                                <th class="text-white" style="background-color: #2f3184;">Jml Reviewer</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <ul class="dropdown-menu">
                                        <li>
                                            <a class="dropdown-item" href="/pembimbing/proposal-proses-detail">Detail</a>
                                        </li>
                                    </ul>
                                </td>
                            </tr>

...
<div class="owl-carousel counter-carousel owl-theme">
  ...
  <div class="item">
    <div class="card border-0 zoom-in bg-danger-subtle shadow-none">
      <div class="card-body">
        <div class="text-center">
          <img src="<?= base_url(); ?>/assets/images/svgs/icon-favorites.svg" width="50" height="50" class="mb-3" alt="modernize-img" />
  ...
  <div class="item">
    <div class="card border-0 zoom-in bg-success-subtle shadow-none">
      <div class="card-body">
        <div class="text-center">
          <img src="<?= base_url(); ?>/assets/images/svgs/icon-speech-bubble.svg" width="50" height="50" class="mb-3" alt="modernize-img" />
  ...
  <div class="item">
    <div class="card border-0 zoom-in bg-info-subtle shadow-none">
      <div class="card-body">
        <div class="text-center">
          <img src="<?= base_url(); ?>/assets/images/svgs/icon-connect.svg" width="50" height="50" class="mb-3" alt="modernize-img" />
    ...
    <div class="card">
      <div class="card-body">
        <div class="d-flex align-items-center mb-7 pb-2">
          <div class="me-3 pe-1">
            <img src="<?= base_url(); ?>/assets/images/profile/user-2.jpg" class="shadow-warning rounded-2" alt="modernize-img" width="72" height="72" />
          </div>
          <div>
          ...
          <ul class="hstack mb-0">
            <li class="ms-n8">
              <a href="javascript:void(0)" class="me-1">
                <img src="<?= base_url(); ?>/assets/images/profile/user-2.jpg" class="rounded-circle border border-2 border-white" width="44" height="44" alt="modernize-img" />
              </a>
            </li>
            <li class="ms-n8">
              <a href="javascript:void(0)" class="me-1">
                <img src="<?= base_url(); ?>/assets/images/profile/user-3.jpg" class="rounded-circle border border-2 border-white" width="44" height="44" alt="modernize-img" />
              </a>
            </li>
            <li class="ms-n8">
              <a href="javascript:void(0)" class="me-1">
                <img src="<?= base_url(); ?>/assets/images/profile/user-4.jpg" class="rounded-circle border border-2 border-white" width="44" height="44" alt="modernize-img" />
              </a>
            </li>
            <li class="ms-n8">
              <a href="javascript:void(0)" class="me-1">
                <img src="<?= base_url(); ?>/assets/images/profile/user-5.jpg" class="rounded-circle border border-2 border-white" width="44" height="44" alt="modernize-img" />
              </a>
            </li>
          </ul>
    ...
    <div class="card text-bg-primary border-0 w-100">
      <div class="card-body pb-0">
        ...
        <div class="text-center mt-3">
          <img src="<?= base_url(); ?>/assets/images/backgrounds/piggy.png" class="img-fluid" alt="modernize-img" />
        </div>
      </div>

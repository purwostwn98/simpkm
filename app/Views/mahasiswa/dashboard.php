        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="d-flex align-items-center mb-7">
              ...
              <h5 class="fw-semibold mb-0 fs-5">Assalamu'alaikuum, <span style="color: #2f3184;">Ahmad Setiawan!</span></h5>
            </div>
            <div class="d-flex align-items-center">
              <div class="border-end pe-4 border-muted border-opacity-10">
                <h3 class="mb-1 fw-semibold fs-8  align-content-center text-center text-white" style="background-color: #2f3184;"> 2
                </h3>
                <p class="mb-0 text-dark">Proposal Diajukan</p>
              </div>
              <div class="ps-4">
                <h3 class="mb-1 fw-semibold fs-8 text-center text-white align-content-center bg-success"> 1
                </h3>
    ...
    <div class="card w-100">
      <div class="card-body">
        <div class="row align-items-center">
          <div class="col-12">
            <h5 class="card-title fw-semibold">
              <a href="#" style="color: #2f3184;"><i class="ti ti-user"></i> Profil Mahasiswa</a> | <button class="btn btn-sm btn-warning"><i class="ti ti-edit"></i> Edit</button>
            </h5>
            <table class="table table-striped table-responsive w-100 table-sm mt-3">
              <tbody>
                <tr>
                  <td>Nama</td>
                  <td><b>Ahmad Setiawan</b></td>
                </tr>
                <tr>
                  <td>NIM</td>
                  <td><b>D600160125</b></td>
                </tr>
                <tr>
                  <td>Email</td>
                  <td><b>d600160125@student.ums.ac.id</b></td>
                </tr>
                <tr>
                  <td>Telepon</td>
